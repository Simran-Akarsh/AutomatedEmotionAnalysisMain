...
def grid_vect(clf, parameters_clf, X_train, X_test, parameters_text=None, vect=None, is_w2v=False):
    textcountscols = ['count_capitl_words','count_emojis','count_excl_quest_marks','count_hashtags', 'count_mentions', 'count_urls', 'count_words']
  ...
  #Join the parameters dictionaries together
    ...
    print("pipeline:", [name for name, _ in pipleline.steps])
    print("parameters:")
    pprint(parameters)
    tO = time
    ...
    print()
    print("Best CV score: %0.3f" % grid_search.bestscore_)
